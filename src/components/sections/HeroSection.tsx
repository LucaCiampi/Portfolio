    ...
    <div>
      <div className="pt-24 z-10">
        <h1
          ...
          className="font-allison text-[130px] leading-[96px] sm:text-[150px] sm:leading-[150px] md:leading-[220px] md:text-[220px] mb-12 lg:mb-0 md:block text-white mix-blend-difference"
        >
        ...
        <div
          ...
          className="text-6xl sm:text-8xl md:text-[124px] md:leading-[130px] lg:pl-40 font-playfair-display text-text-header mt-32 lg:mt-0"
        >
